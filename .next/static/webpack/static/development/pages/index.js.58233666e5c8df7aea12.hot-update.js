...
function Uploader() {
  ...
  function convert(kml, file) {
    ...
    dlAnchorElem.setAttribute("download", "{file.name.slice(0, -4).".concat(extension));
    dlAnchorElem.click();
  }
